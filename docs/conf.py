# -*- coding: utf-8 -*-
#
# django-request-id documentation build configuration file, created by
...
version = request_id.__version__
# The full version, including alpha/beta/rc tags.
release = request_id.__version__
...
htmlhelp_basename = 'django-request-iddoc'
...
latex_documents = [
  ('index', 'django-request-id.tex', u'django-request-id Documentation',
...
man_pages = [
    ('index', 'django-request-id', u'django-request-id Documentation',
...
texinfo_documents = [
  ('index', 'django-request-id', u'django-request-id Documentation',
   u'Filip Wasilewski', 'django-request-id', 'One line description of project.',
   'Miscellaneous'),
]
